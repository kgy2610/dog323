   ...
   <section id="mypage-bg">
        ...
        <div id="mypage-menu">
            <div id="mp-menu">
              <ul>
                ...
                <li><font color="#FF9E00">비밀번호 변경</font></li>
      ...
      <form method="post" action="updatePwResult.jsp"  onsubmit="return checkValue2()">
        <div id="mp-pwchange">
            <table>
                <tr>
         <td lass="pwcg">현재 비밀번호</td>
         <td><input type="hidden" name="no" value="<%=id%>"><%=memPw%></td>
      </tr>
                <tr><td class="pwcg">새 비밀번호</td><td class="pwcg-input"><input type="password" name="memPw" value="<%=memPw%>" required></td></tr>
                <tr><td class="pwcg">새 비밀번호 확인</td><td class="pwcg-input"><input type="password" placeholder="새 비밀번호를 다시 입력하세요"></td></tr>
            </table>
